<template>
  <a-card :bordered="false" class="card-area">
          ...
          <div :class="advanced ? null: 'fold'">
            ...
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                :labelCol="{span: 5}"
                :wrapperCol="{span: 18, offset: 1}">
                <a-input v-model="queryParams.createBy"/>
              </a-form-item>
            </a-col>
          </div>
    ...
    <exam-add
      ...
      :examAddVisiable="examAdd.visiable">
    </exam-add>
    <exam-edit
      ref="examEdit"
      @close="handleexamEditClose"
      @success="handleexamEditSuccess"
      :examEditVisiable="examEdit.visiable">
    </exam-edit>
    <exam-view
...
import examAdd from './ExamAdd.vue'
...
export default {
  name: 'exam',
  components: {examAdd, examEdit, RangeDate, examView},
  data () {
    return {
      advanced: false,
      examAdd: {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/exam-paper-info/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/exam-paper-info/page', {
        ...params
      }).then((r) => {
