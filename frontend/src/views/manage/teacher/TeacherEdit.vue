  ...
  <a-modal v-model="show" title="修改教师" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        ...
        <a-col :span="12">
          <a-form-item label='履历' v-bind="formItemLayout">
            <a-input v-decorator="[
            'resume',
            { rules: [{ required: true, message: '请输入履历!' }] }
            ]"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label='擅长' v-bind="formItemLayout">
            <a-input v-decorator="[
            'expert',
...
export default {
  ...
  methods: {
    ...
    setFormValues ({...teacher}) {
      ...
      let fields = ['name', 'sex', 'birthday', 'phone', 'content', 'status', 'resume', 'expert']
      let obj = {}
