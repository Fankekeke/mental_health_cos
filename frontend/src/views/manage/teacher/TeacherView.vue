<template>
  <a-modal v-model="show" title="教师详情" @cancel="onClose" :width="800">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="teacherData !== null">
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="8"><b>教师编号：</b>
          {{ teacherData.code ? teacherData.code : '- -' }}
        </a-col>
...
export default {
  ...
  watch: {
    teacherShow: function (value) {
      if (value) {
        if (this.teacherData.images) {
          this.imagesInit(this.teacherData.images)
        }
      }
    }
  },
  methods: {
    local (teacherData) {
      ...
      let point = new BMap.Point(teacherData.longitude, teacherData.latitude)
