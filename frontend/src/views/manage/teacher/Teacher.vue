    ...
    <div>
      ...
      <a-table ref="TableInfo"
        ...
        <template slot="operation" slot-scope="text, record">
          ...
          <a-icon type="file-search" @click="teacherViewOpen(record)" title="详 情" style="margin-left: 15px"></a-icon>
        </template>
      </a-table>
    </div>
    <teacher-add
      v-if="teacherAdd.visiable"
      @close="handleteacherAddClose"
      @success="handleteacherAddSuccess"
      :teacherAddVisiable="teacherAdd.visiable">
    </teacher-add>
    <teacher-edit
      ref="teacherEdit"
...
export default {
  name: 'teacher',
  components: {teacherAdd, teacherEdit, RangeDate, teacherView},
  data () {
    return {
      advanced: false,
      teacherAdd: {
